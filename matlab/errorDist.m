...
% folder = "/media/haisenberg/BIGLUCK/Datasets/NCLT/datasets/fastlio_loc";
...
% plot(timeLog,isTMM);
% legend("Mapping inlier ratio","Absolute localization error");
%% scene change
...
plot(matPose(idx1,2),matPose(idx1,3),".","MarkerSize",4);
